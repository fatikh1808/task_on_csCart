...
(function (_, $) {
    ...
    var editor = {
        ...
        run: function ($el, params) {
            ...
            editor.params.toolbar = 'formatselect fontselect fontsizeselect bold italic underline forecolor backcolor | link image | numlist bullist indent outdent | alignleft aligncenter alignright alignjustify | code';
            if (_.area == 'C') {
