<?php /* Smarty version Smarty-3.1.21, created on 2020-07-21 08:18:36
         compiled from "C:\xampp\htdocs\task_on_csCart\design\backend\templates\pickers\products\js.tpl" */ ?>
<?php /*%%SmartyHeaderCode:14297069105f167aac5ce716-91260406%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '0f47baed7e9cc77862f5140866a3728bd7a93000' => 
    array (
      0 => 'C:\\xampp\\htdocs\\task_on_csCart\\design\\backend\\templates\\pickers\\products\\js.tpl',
      1 => 1590666263,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '14297069105f167aac5ce716-91260406',
  'function' => 
  array (
  ),
  'variables' => 
  array (
    ...
    'company_name' => 0,
    'product_data_for_company_name' => 0,
    'holder' => 0,
    'first_item' => 0,
    'single_line' => 0,
    'extra_class' => 0,
  ...
  'unifunc' => 'content_5f167aac76abc3_51573239',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5f167aac76abc3_51573239')) {function content_5f167aac76abc3_51573239($_smarty_tpl) {?><?php if (!is_callable('smarty_function_math')) include 'C:\\xampp\\htdocs\\task_on_csCart\\app\\lib\\vendor\\smarty\\smarty\\libs\\plugins\\function.math.php';
...
<?php if ($_smarty_tpl->tpl_vars['runtime']->value['company_id']&&$_smarty_tpl->tpl_vars['product_data']->value['company_id']!=$_smarty_tpl->tpl_vars['runtime']->value['company_id']) {?>
...
">
            <?php $_smarty_tpl->smarty->_tag_stack[] = array('hook', array('name'=>"product_picker:table_column_name")); $_block_repeat=true; echo smarty_block_hook(array('name'=>"product_picker:table_column_name"), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>

                <?php if (!$_smarty_tpl->tpl_vars['show_only_name']->value) {?>
                    <a href="<?php echo htmlspecialchars(fn_url("products.update?product_id=".((string)$_smarty_tpl->tpl_vars['delete_id']->value)), ENT_QUOTES, 'UTF-8');?>
"><?php echo $_smarty_tpl->tpl_vars['product']->value;?>
                ...
                <?php $_smarty_tpl->tpl_vars['product_data_for_company_name'] = new Smarty_variable(array("company_name"=>$_smarty_tpl->tpl_vars['company_name']->value), null, 0);?>
                
                <?php if (!$_smarty_tpl->tpl_vars['clone']->value) {?>
                    <?php $_smarty_tpl->tpl_vars['product_data_for_company_name'] = new Smarty_variable($_smarty_tpl->tpl_vars['product_data']->value, null, 0);?>
                <?php }?>
                <?php echo $_smarty_tpl->getSubTemplate ("views/companies/components/company_name.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('object'=>$_smarty_tpl->tpl_vars['product_data_for_company_name']->value), 0);?>

            <?php $_block_content = ob_get_clean(); $_block_repeat=false; echo smarty_block_hook(array('name'=>"product_picker:table_column_name"), $_block_content, $_smarty_tpl, $_block_repeat);  } array_pop($_smarty_tpl->smarty->_tag_stack);?>
