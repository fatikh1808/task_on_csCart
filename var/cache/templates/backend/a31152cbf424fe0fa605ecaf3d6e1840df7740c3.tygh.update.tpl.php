<?php /* Smarty version Smarty-3.1.21, created on 2020-07-21 08:28:25
         compiled from "C:\xampp\htdocs\task_on_csCart\design\backend\templates\views\product_options\update.tpl" */ ?>
<?php /*%%SmartyHeaderCode:13679496395f167cf99ed9f8-47988128%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'a31152cbf424fe0fa605ecaf3d6e1840df7740c3' => 
    array (
      0 => 'C:\\xampp\\htdocs\\task_on_csCart\\design\\backend\\templates\\views\\product_options\\update.tpl',
      1 => 1590666263,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '13679496395f167cf99ed9f8-47988128',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5f167cf9d58024_11194648',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5f167cf9d58024_11194648')) {function content_5f167cf9d58024_11194648($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_enum')) include 'C:/xampp/htdocs/task_on_csCart/app/functions/smarty_plugins\\modifier.enum.php';
if (!is_callable('smarty_block_hook')) include 'C:/xampp/htdocs/task_on_csCart/app/functions/smarty_plugins\\block.hook.php';
if (!is_callable('smarty_function_math')) include 'C:\\xampp\\htdocs\\task_on_csCart\\app\\lib\\vendor\\smarty\\smarty\\libs\\plugins\\function.math.php';
...
" class="control-label cm-required"><?php echo $_smarty_tpl->__("name");?>
            ...
            <div class="controls">
                <input class="input-large" type="text" name="option_data[option_name]" id="elm_option_name_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['id']->value, ENT_QUOTES, 'UTF-8');?>
...
"/>
        ...
        <div class="control-group">
            <label for="elm_internal_option_name_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['id']->value, ENT_QUOTES, 'UTF-8');?>
" class="control-label"><?php echo $_smarty_tpl->__("code");?>
 <?php ob_start();?><?php echo $_smarty_tpl->__("internal_option_name_tooltip");?>
<?php $_tmp20=ob_get_clean();?><?php echo $_smarty_tpl->getSubTemplate ("common/tooltip.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('tooltip'=>$_tmp20), 0);?>
</label>
            <div class="controls">
                <input class="input-large" type="text" name="option_data[internal_option_name]" id="elm_internal_option_name_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['id']->value, ENT_QUOTES, 'UTF-8');?>
" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['option_data']->value['internal_option_name'], ENT_QUOTES, 'UTF-8');?>
"/>
            </div>
        </div>
...
" class="hand cm-combinations-options-<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['id']->value, ENT_QUOTES, 'UTF-8');?>
 icon-caret-right"></div><div id="off_st_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['id']->value, ENT_QUOTES, 'UTF-8');?>
" alt="<?php echo $_smarty_tpl->__("expand_collapse_list");?>
" title="<?php echo $_smarty_tpl->__("expand_collapse_list");?>
...
$_smarty_tpl->tpl_vars["vr"] = new Smarty_variable('', null, 0);?>
            <tbody class="hover cm-row-item <?php if ($_smarty_tpl->tpl_vars['option_data']->value['option_type']==smarty_modifier_enum("ProductOptionTypes::CHECKBOX")) {?>hidden<?php }?>" id="box_add_variant_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['id']->value, ENT_QUOTES, 'UTF-8');?>
">
            <tr>
...
<?php echo '<script'; ?>
 ...
 (function (_, $) {
	 ...
	 '<?php echo htmlspecialchars(smarty_modifier_enum("ProductOptionTypes::SELECTBOX"), ENT_QUOTES, 'UTF-8');?>
',
	 '<?php echo htmlspecialchars(smarty_modifier_enum("ProductOptionTypes::RADIO_GROUP"), ENT_QUOTES, 'UTF-8');?>
',
	 '<?php echo htmlspecialchars(smarty_modifier_enum("ProductOptionTypes::CHECKBOX"), ENT_QUOTES, 'UTF-8');?>
'
     ];
