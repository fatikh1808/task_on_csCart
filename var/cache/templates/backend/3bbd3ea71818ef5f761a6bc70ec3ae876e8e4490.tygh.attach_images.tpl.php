<?php /* Smarty version Smarty-3.1.21, created on 2020-07-21 08:18:10
         compiled from "C:\xampp\htdocs\task_on_csCart\design\backend\templates\common\attach_images.tpl" */ ?>
<?php /*%%SmartyHeaderCode:16565852355f167a92160580-08117009%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '3bbd3ea71818ef5f761a6bc70ec3ae876e8e4490' => 
    array (
      0 => 'C:\\xampp\\htdocs\\task_on_csCart\\design\\backend\\templates\\common\\attach_images.tpl',
      1 => 1590666263,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '16565852355f167a92160580-08117009',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5f167a923a36a2_85084254',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5f167a923a36a2_85084254')) {function content_5f167a923a36a2_85084254($_smarty_tpl) {?><?php if (!is_callable('smarty_block_inline_script')) include 'C:/xampp/htdocs/task_on_csCart/app/functions/smarty_plugins\\block.inline_script.php';
...
(function(_, $) {
    $.ceEvent('on', 'ce.ajaxlink.done.delete_image', function(e, r, p) {
        if (r.deleted == true) {
    ...
    $.ceEvent('on', 'ce.ajaxlink.done.delete_image_pair', function(e, r, p) {
        if (r.deleted == true) {
            $('#' + p.result_ids).remove();
        }        
    });    
...
echo htmlspecialchars($_smarty_tpl->tpl_vars['detailed_text']->value, ENT_QUOTES, 'UTF-8');
}?>
            :</span>
        </div>
        <?php }?>
...
" class="cm-confirm cm-post cm-ajax cm-tooltip pull-right" data-ca-event-name="delete_image_pair" title="<?php echo $_smarty_tpl->__("delete_image_pair");?>
...
" class="image-delete cm-confirm cm-post cm-ajax delete cm-delete-image-link cm-tooltip" data-ca-event-name="delete_image" title="<?php echo $_smarty_tpl->__("remove");?>
...
" class="image-delete cm-confirm cm-post cm-tooltip cm-ajax delete cm-delete-image-link" data-ca-event-name="delete_image" title="<?php echo $_smarty_tpl->__("remove");?>
"><i class="icon-remove-sign"></i></a>
                    <?php }?>
                <?php }?>
                <div class="image">
