<?php /* Smarty version Smarty-3.1.21, created on 2020-07-21 08:28:24
         compiled from "C:\xampp\htdocs\task_on_csCart\design\backend\templates\views\product_options\manage.tpl" */ ?>
<?php /*%%SmartyHeaderCode:11684579115f167cf8a6aa48-02765730%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '0187c5b524468552a706fd841d382712d7b91abb' => 
    array (
      0 => 'C:\\xampp\\htdocs\\task_on_csCart\\design\\backend\\templates\\views\\product_options\\manage.tpl',
      1 => 1590666263,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '11684579115f167cf8a6aa48-02765730',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5f167cf8c41ca2_53035019',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5f167cf8c41ca2_53035019')) {function content_5f167cf8c41ca2_53035019($_smarty_tpl) {?><?php if (!is_callable('smarty_function_script')) include 'C:/xampp/htdocs/task_on_csCart/app/functions/smarty_plugins\\function.script.php';
            ...
            <?php $_smarty_tpl->_capture_stack[0][] = array("buttons", null, null); ob_start(); ?>
                <?php if ($_smarty_tpl->tpl_vars['product_options']->value&&$_smarty_tpl->tpl_vars['object']->value=="global") {?>
                    <?php $_smarty_tpl->_capture_stack[0][] = array("tools_list", null, null); ob_start(); ?>
                        ...
                        <li><?php smarty_template_function_btn($_smarty_tpl,array('type'=>"delete_selected",'dispatch'=>"dispatch[product_options.m_delete]",'form'=>"manage_product_options_form"));?>
</li>
                    <?php list($_capture_buffer, $_capture_assign, $_capture_append) = array_pop($_smarty_tpl->_capture_stack[0]);
if (!empty($_capture_buffer)) {
 if (isset($_capture_assign)) $_smarty_tpl->assign($_capture_assign, ob_get_contents());
...
<?php $_tmp14=ob_get_clean();?><?php echo $_smarty_tpl->getSubTemplate ("common/tooltip.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('tooltip'=>$_tmp14), 0);?>
...
$_tmp15=ob_get_clean();?><?php $_smarty_tpl->tpl_vars['details'] = new Smarty_variable("(".$_tmp15.")", null, 0);?>
                                    ...
                                    <?php if ($_smarty_tpl->tpl_vars['product_option']->value['internal_option_name']) {?>
                                        <?php $_smarty_tpl->tpl_vars['internal_option_name'] = new Smarty_variable("<br />".((string)$_smarty_tpl->tpl_vars['product_option']->value['internal_option_name']), null, 0);?>
                                    <?php }?>
...
$_tmp19=ob_get_clean();?><?php echo $_smarty_tpl->getSubTemplate ("common/object_group.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('no_table'=>true,'no_padding'=>true,'id'=>$_smarty_tpl->tpl_vars['product_option']->value['option_id'],'id_prefix'=>"_product_option_",'details'=>$_smarty_tpl->tpl_vars['details']->value,'text'=>$_smarty_tpl->tpl_vars['product_option']->value['option_name'],'href_desc'=>$_smarty_tpl->tpl_vars['internal_option_name']->value,'hide_for_vendor'=>$_smarty_tpl->tpl_vars['hide_for_vendor']->value,'status'=>$_smarty_tpl->tpl_vars['status']->value,'table'=>"product_options",'object_id_name'=>"option_id",'href'=>"product_options.update?option_id=".((string)$_smarty_tpl->tpl_vars['product_option']->value['option_id']).((string)$_smarty_tpl->tpl_vars['query_product_id']->value),'href_delete'=>$_smarty_tpl->tpl_vars['href_delete']->value,'delete_target_id'=>$_smarty_tpl->tpl_vars['delete_target_id']->value,'header_text'=>$_tmp16.": ".((string)$_smarty_tpl->tpl_vars['product_option']->value['option_name']),'skip_delete'=>!$_smarty_tpl->tpl_vars['allow_save']->value,'additional_class'=>$_smarty_tpl->tpl_vars['additional_class']->value,'prefix'=>"product_options",'link_text'=>$_smarty_tpl->tpl_vars['link_text']->value,'non_editable'=>$_smarty_tpl->tpl_vars['non_editable']->value,'company_object'=>$_smarty_tpl->tpl_vars['product_option']->value,'href_desc_row_hint'=>$_tmp17." / ".$_tmp18,'status_row_hint'=>$_tmp19,'checkbox_name'=>"option_ids[]",'show_checkboxes'=>$_smarty_tpl->tpl_vars['show_checkboxes']->value), 0);?>
