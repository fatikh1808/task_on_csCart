<?php /* Smarty version Smarty-3.1.21, created on 2020-07-21 08:20:54
         compiled from "C:\xampp\htdocs\task_on_csCart\design\backend\templates\views\block_manager\update_block.tpl" */ ?>
<?php /*%%SmartyHeaderCode:5449463715f167b3602ab55-19275868%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '5739cdb3375754d68436b9c0cfdac496e89a2886' => 
    array (
      0 => 'C:\\xampp\\htdocs\\task_on_csCart\\design\\backend\\templates\\views\\block_manager\\update_block.tpl',
      1 => 1590666263,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '5449463715f167b3602ab55-19275868',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5f167b363c97b0_40416764',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5f167b363c97b0_40416764')) {function content_5f167b363c97b0_40416764($_smarty_tpl) {?><?php if (!is_callable('smarty_function_script')) include 'C:/xampp/htdocs/task_on_csCart/app/functions/smarty_plugins\\function.script.php';
if (!is_callable('smarty_block_hook')) include 'C:/xampp/htdocs/task_on_csCart/app/functions/smarty_plugins\\block.hook.php';
if (!is_callable('smarty_function_include_ext')) include 'C:/xampp/htdocs/task_on_csCart/app/functions/smarty_plugins\\function.include_ext.php';
?><?php
...
--></div>
    ...
    <?php if (fn_allowed_for("ULTIMATE")) {?>
        <input type="hidden" name="switch_company_id" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['runtime']->value['company_id'], ENT_QUOTES, 'UTF-8');?>
" class="cm-no-hide-input" />
    <?php }?>
    <?php if (fn_allowed_for("MULTIVENDOR")) {?>
        <input type="hidden" name="s_storefront" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['app']->value['storefront']->storefront_id, ENT_QUOTES, 'UTF-8');?>
" class="cm-no-hide-input" />
    <?php }?>
    <input type="hidden" name="descr_sl" value="<?php echo htmlspecialchars(@constant('DESCR_SL'), ENT_QUOTES, 'UTF-8');?>
" class="cm-no-hide-input" />
</form>
<?php }} ?>
