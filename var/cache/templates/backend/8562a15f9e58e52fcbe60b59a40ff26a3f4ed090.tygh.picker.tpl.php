<?php /* Smarty version Smarty-3.1.21, created on 2020-07-21 08:18:35
         compiled from "C:\xampp\htdocs\task_on_csCart\design\backend\templates\pickers\products\picker.tpl" */ ?>
<?php /*%%SmartyHeaderCode:14903427895f167aab499615-26797184%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '8562a15f9e58e52fcbe60b59a40ff26a3f4ed090' => 
    array (
      0 => 'C:\\xampp\\htdocs\\task_on_csCart\\design\\backend\\templates\\pickers\\products\\picker.tpl',
      1 => 1590666263,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '14903427895f167aab499615-26797184',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5f167aab72b487_97211282',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5f167aab72b487_97211282')) {function content_5f167aab72b487_97211282($_smarty_tpl) {?><?php if (!is_callable('smarty_function_math')) include 'C:\\xampp\\htdocs\\task_on_csCart\\app\\lib\\vendor\\smarty\\smarty\\libs\\plugins\\function.math.php';
...
if (!is_callable('smarty_modifier_count')) include 'C:/xampp/htdocs/task_on_csCart/app/functions/smarty_plugins\\modifier.count.php';
...
" class="<?php if (!$_smarty_tpl->tpl_vars['item_ids']->value) {?>hidden<?php }?> cm-picker-product">
        <?php echo $_smarty_tpl->getSubTemplate ("pickers/products/js.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('clone'=>true,'product'=>((string)$_smarty_tpl->tpl_vars['ldelim']->value)."product".((string)$_smarty_tpl->tpl_vars['rdelim']->value),'company_id'=>((string)$_smarty_tpl->tpl_vars['ldelim']->value)."company_id".((string)$_smarty_tpl->tpl_vars['rdelim']->value),'company_name'=>((string)$_smarty_tpl->tpl_vars['ldelim']->value)."company_name".((string)$_smarty_tpl->tpl_vars['rdelim']->value),'root_id'=>$_smarty_tpl->tpl_vars['data_id']->value,'delete_id'=>((string)$_smarty_tpl->tpl_vars['ldelim']->value)."delete_id".((string)$_smarty_tpl->tpl_vars['rdelim']->value),'type'=>"product",'position_field'=>$_smarty_tpl->tpl_vars['positions']->value,'position'=>"0"), 0);?>
