<?php /* Smarty version Smarty-3.1.21, created on 2020-07-21 08:03:09
         compiled from "C:\xampp\htdocs\task_on_csCart\design\themes\responsive\templates\views\auth\login_form.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1626386655f16770d996158-96695210%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'c7a8f0698337821098c6e86f18a71e73799fce59' => 
    array (
      0 => 'C:\\xampp\\htdocs\\task_on_csCart\\design\\themes\\responsive\\templates\\views\\auth\\login_form.tpl',
      1 => 1595307348,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '1626386655f16770d996158-96695210',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5f16770da7ad97_84640234',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5f16770da7ad97_84640234')) {function content_5f16770da7ad97_84640234($_smarty_tpl) {?><?php if (!is_callable('smarty_block_hook')) include 'C:/xampp/htdocs/task_on_csCart/app/functions/smarty_plugins\\block.hook.php';
...
" method="post" <?php if ($_smarty_tpl->tpl_vars['style']->value=="popup") {?>class="cm-ajax cm-ajax-full-render"<?php }?>>
        <?php if ($_smarty_tpl->tpl_vars['style']->value=="popup") {?>
            <input type="hidden" name="result_ids" value="login_error_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['id']->value, ENT_QUOTES, 'UTF-8');?>
" />
            <input type="hidden" name="error_container_id" value="login_error_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['id']->value, ENT_QUOTES, 'UTF-8');?>
" />
...
" class="ty-login__input" maxlength="32" />
        ...
        <?php if ($_smarty_tpl->tpl_vars['style']->value=="popup") {?>
            <?php echo $_smarty_tpl->getSubTemplate ("views/auth/components/login_errors.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array(), 0);?>
