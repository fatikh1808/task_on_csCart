...
$schema = [
    ...
    'order.edp' => [
        ...
        'data_provider' => function (array $data) {
            return array_merge($data, [
                'order_files_list_url' => fn_url("orders.order_downloads&order_id={$data['order_info']['order_id']}&storefront_id={$data['order_info']['storefront_id']}", 'C')
            ]);
        },
        'receivers' => [
            UserTypes::CUSTOMER => [
    ...
    'profile.password_reminder' => [
        ...
        'data_provider' => function (array $data) {
            ...
            return array_merge($data, [
                ...
                'url'       => fn_url('auth.password_change', $user_data['user_type'], (Registry::get('settings.Security.secure_admin') == 'Y') ? 'https' : 'http'),
